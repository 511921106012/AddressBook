...
void editContact(AddressBook *addressBook)
{
	...
	if(count>1)
	{
		printf("contect have smiler name what you want to edit \n");
...
int validphone(AddressBook *addresBook,char *phone)
{
	...
	if(strlen(phone)!=10)
	{
		printf("you should enter the only digit 10 characters\n");
		return 0;
